  ...
  return (
    <div className="min-h-screen bg-[#F9F7F2]">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#F9F7F2]/80 backdrop-blur-md border-b border-[#2C3E30]/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            <button onClick={function() { scrollTo("details"); }} className="text-sm tracking-widest uppercase text-[#5C6B5F] hover:text-[#2C3E30]" data-testid="nav-details">Detalii</button>
            <button onClick={function() { scrollTo("locations"); }} className="text-sm tracking-widest uppercase text-[#5C6B5F] hover:text-[#2C3E30]" data-testid="nav-locations">Locatii</button>
      ...
      <section className="min-h-screen flex flex-col justify-center items-center text-center relative overflow-hidden pt-20">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1519741497674-611481863552?w=1920&q=80')" }}></div>
        <div className="absolute inset-0 bg-gradient-to-b from-[#F9F7F2]/40 via-[#F9F7F2]/60 to-[#F9F7F2]"></div>
        ...
        <button onClick={function() { scrollTo("details"); }} className="absolute bottom-10 left-1/2 -translate-x-1/2 text-[#5C6B5F] animate-bounce" data-testid="scroll-down-btn">
          <ChevronDown size={32} />
        </button>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="location-card p-8 md:p-10">
              ...
              <div className="flex flex-wrap gap-3">
                <a href="https://maps.google.com/?q=Biserica+Adventista+Brancoveanu+Bucuresti" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-[#2C3E30] text-[#F9F7F2] font-serif text-sm" data-testid="church-maps-btn"><ExternalLink size={16} /> Google Maps</a>
                <a href="https://waze.com/ul?q=Biserica+Adventista+Brancoveanu+Bucuresti" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 border border-[#2C3E30] text-[#2C3E30] font-serif text-sm hover:bg-[#2C3E30] hover:text-[#F9F7F2]" data-testid="church-waze-btn"><Navigation size={16} /> Waze</a>
              </div>
            </div>
            <div className="location-card p-8 md:p-10">
              <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex flex-wrap gap-3">
                <a href="https://maps.google.com/?q=Domeniul+Monato+Bolintin+Vale" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-[#2C3E30] text-[#F9F7F2] font-serif text-sm" data-testid="venue-maps-btn"><ExternalLink size={16} /> Google Maps</a>
                <a href="https://waze.com/ul?q=Domeniul+Monato+Bolintin+Vale" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 border border-[#2C3E30] text-[#2C3E30] font-serif text-sm hover:bg-[#2C3E30] hover:text-[#F9F7F2]" data-testid="venue-waze-btn"><Navigation size={16} /> Waze</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {galleryPhotos.length > 0 ? (
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
              {galleryPhotos.map(function(photo, idx) { return (<div key={photo.id} className="aspect-square overflow-hidden"><img src={API + "/photos/file/" + photo.filename} alt={"Gallery " + (idx+1)} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" /></div>); })}
            </div>
          ) : (
          ...
          <div className="text-center">
            <Link to="/gallery" className="inline-flex items-center gap-2 px-10 py-4 bg-[#2C3E30] text-[#F9F7F2] font-serif text-lg hover:bg-[#1A261D]" data-testid="gallery-upload-btn"><Camera size={20} /> Incarca Poze</Link>
          </div>
        </div>
      </section>

      <section className="py-24 md:py-32 px-6 relative overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-20" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1528696466037-2883fc6c2d4a?w=1920&q=80')" }}></div>
