      ...
      <nav className={"fixed top-0 left-0 right-0 z-50 transition-all duration-500 " + (scrolled ? "bg-[#FAF8F5]/90 backdrop-blur-md shadow-sm" : "bg-transparent") + " " + (visible ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0")}>
        <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            <button onClick={function() { scrollTo("details"); }} className={"text-sm tracking-widest uppercase transition-colors duration-300 " + (scrolled ? "text-[#6B7B7B] hover:text-[#7D9B8C]" : "text-white/90 hover:text-white drop-shadow")} data-testid="nav-details">Detalii</button>
            <button onClick={function() { scrollTo("locations"); }} className={"text-sm tracking-widest uppercase transition-colors duration-300 " + (scrolled ? "text-[#6B7B7B] hover:text-[#7D9B8C]" : "text-white/90 hover:text-white drop-shadow")} data-testid="nav-locations">Locatii</button>
            <Link to="/gallery" className={"text-sm tracking-widest uppercase transition-colors duration-300 " + (scrolled ? "text-[#6B7B7B] hover:text-[#7D9B8C]" : "text-white/90 hover:text-white drop-shadow")} data-testid="nav-gallery">Galerie</Link>
          </div>
        </div>
      </nav>
