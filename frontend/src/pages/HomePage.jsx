...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5]">
      ...
      <nav className={"fixed top-0 left-0 right-0 z-50 transition-all duration-500 " + (scrolled ? "bg-[#FAF8F5]/90 backdrop-blur-md shadow-sm" : "bg-transparent") + " " + (visible ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0")}>
        <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
          <Link to="/" className={"font-script text-3xl transition-colors duration-300 " + (scrolled ? "text-[#3D4F4F]" : "text-white drop-shadow-lg")} data-testid="nav-logo">S <span className="text-[#B8977E]">&</span> A</Link>
          <div className="hidden md:flex items-center gap-8">
            <button onClick={function() { scrollTo("details"); }} className={"text-sm tracking-widest uppercase transition-colors duration-300 " + (scrolled ? "text-[#6B7B7B] hover:text-[#4A6B8A]" : "text-white/90 hover:text-white drop-shadow")} data-testid="nav-details">Detalii</button>
            <button onClick={function() { scrollTo("locations"); }} className={"text-sm tracking-widest uppercase transition-colors duration-300 " + (scrolled ? "text-[#6B7B7B] hover:text-[#4A6B8A]" : "text-white/90 hover:text-white drop-shadow")} data-testid="nav-locations">Locatii</button>
            <Link to="/gallery" className={"text-sm tracking-widest uppercase transition-colors duration-300 " + (scrolled ? "text-[#6B7B7B] hover:text-[#4A6B8A]" : "text-white/90 hover:text-white drop-shadow")} data-testid="nav-gallery">Galerie</Link>
          </div>
        </div>
      </nav>
      ...
      <section className="min-h-screen flex flex-col justify-center items-center text-center relative overflow-hidden">
        ...
        <div className={"relative z-10 px-6 transition-all duration-1000 " + (visible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0")}>
          ...
          <Link to="/rsvp" className="inline-block px-10 py-4 bg-[#3D4F4F] text-[#FAF8F5] font-serif text-lg rounded-full hover:bg-[#4A6B8A] hover:scale-105 hover:shadow-xl transition-all duration-300 animate-fade-in" style={{animationDelay: "1s"}} data-testid="hero-rsvp-btn">Confirma Prezenta</Link>
        </div>
      ...
      <section id="details" className="py-24 md:py-32 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm tracking-[0.2em] uppercase text-[#4A6B8A] mb-4">Salveaza data</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-center p-10 bg-white rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
              <div className="w-16 h-16 bg-[#E8E4DF] rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-[#4A6B8A] group-hover:scale-110 transition-all duration-300">
                <Calendar className="w-8 h-8 text-[#4A6B8A] group-hover:text-white transition-colors duration-300" />
              </div>
            ...
            <div className="text-center p-10 bg-white rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
              <div className="w-16 h-16 bg-[#E8E4DF] rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-[#4A6B8A] group-hover:scale-110 transition-all duration-300">
                <Clock className="w-8 h-8 text-[#4A6B8A] group-hover:text-white transition-colors duration-300" />
              </div>
      ...
      <section id="locations" className="py-24 md:py-32 px-6 bg-gradient-to-b from-[#F0EDE8] to-[#FAF8F5]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm tracking-[0.2em] uppercase text-[#4A6B8A] mb-4">Unde ne vedem</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 md:p-10 rounded-3xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
              <div className="flex items-start gap-4 mb-6">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#4A6B8A] to-[#3A5570] flex items-center justify-center flex-shrink-0 shadow-lg">
                  <MapPin className="w-7 h-7 text-white" />
                </div>
                <div>
                  <p className="text-sm tracking-widest uppercase text-[#4A6B8A] mb-1">Ceremonia religioasa</p>
              ...
              <p className="text-[#4A6B8A] font-medium mb-8">Ora: 15:00</p>
              <div className="flex flex-wrap gap-3">
                <a href="https://www.google.com/maps/search/?api=1&query=Biserica+Adventista+Brancoveanu+Bucuresti" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-[#3D4F4F] text-[#FAF8F5] font-medium text-sm rounded-full hover:bg-[#4A6B8A] hover:scale-105 transition-all duration-300" data-testid="church-maps-btn"><ExternalLink size={16} /> Google Maps</a>
      ...
      <section className="py-24 md:py-32 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="max-w-xl">
            <div className="w-20 h-20 bg-gradient-to-br from-[#4A6B8A] to-[#3A5570] rounded-full flex items-center justify-center mb-8 shadow-lg">
            ...
            <Link to="/rsvp" className="inline-block px-12 py-5 bg-[#3D4F4F] text-[#FAF8F5] font-serif text-lg rounded-full hover:bg-[#4A6B8A] hover:scale-105 hover:shadow-xl transition-all duration-300" data-testid="cta-rsvp-btn">Confirma Prezenta</Link>
          </div>
        </div>
      </section>
      ...
      <section id="program" className="py-24 md:py-32 px-6 bg-gradient-to-b from-[#FAF8F5] to-[#F0EDE8]">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-sm tracking-[0.2em] uppercase text-[#4A6B8A] mb-4">Programul zilei</p>
          ...
          <div className="p-12 bg-white rounded-3xl shadow-lg">
            ...
            <p className="text-[#4A6B8A] mt-4">Va multumim pentru rabdare!</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 px-6 bg-[#F0EDE8]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm tracking-[0.2em] uppercase text-[#4A6B8A] mb-4">Amintiri</p>
          ...
          {galleryPhotos.length > 0 ? (
            ...
            <div className="text-center p-12 bg-white rounded-3xl shadow-lg mb-12">
              <Camera className="w-16 h-16 mx-auto mb-4 text-[#4A6B8A] animate-pulse" />
              <p className="text-[#6B7B7B] text-lg">Galeria va fi populata cu poze in curand.</p>
            </div>
          )}
          <div className="text-center">
            <Link to="/gallery" className="inline-flex items-center gap-3 px-10 py-4 bg-[#3D4F4F] text-[#FAF8F5] font-serif text-lg rounded-full hover:bg-[#4A6B8A] hover:scale-105 hover:shadow-xl transition-all duration-300" data-testid="gallery-upload-btn"><Camera size={22} /> Incarca Poze</Link>
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 px-6 bg-[#3D4F4F] text-[#FAF8F5]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-[#4A6B8A]">28 Iunie 2026</p>
          </div>
